        ...
        <table style="width: 100%; border-collapse: collapse; min-width: 700px; font-size: 0.95rem;">
            <thead>
                <tr style="background: linear-gradient(90deg, var(--accent-blue), var(--accent-purple)); color: white;">
                    ...
                    <th style="padding: 15px; text-align: left; width: 37.5%; border-right: 1px solid rgba(255,255,255,0.2);">âœ… CuÃ¡ndo es Ventaja (y por quÃ©)</th>
                    <th style="padding: 15px; text-align: left; width: 37.5%;">âŒ CuÃ¡ndo es Desventaja (y por quÃ©)</th>
                </tr>
            </thead>
            <tbody>
                <!-- Concepto General -->
                <tr style="border-bottom: 1px solid #333; background: rgba(255,255,255,0.02);">
                    ...
                    <td style="padding: 15px; border-right: 1px solid #333; color: #ccc;">
                        <strong>Modelo simple.</strong> Es fÃ¡cil de comprender y estructurar mentalmente, lo que facilita la comunicaciÃ³n inicial del equipo.
                    </td>
                    <td style="padding: 15px; color: #ccc;">
                        Puede volverse complejo y difÃ­cil de manejar en aplicaciones grandes debido a la falta de reglas estrictas de comunicaciÃ³n.
                    </td>
                </tr>
                <!-- Aprendizaje -->
                <tr style="border-bottom: 1px solid #333;">
                    ...
                    <td style="padding: 15px; border-right: 1px solid #333; color: #ccc;">
                        <strong>Baja curva de aprendizaje.</strong> Ideal para desarrolladores principiantes o equipos que necesitan integrar nuevos miembros rÃ¡pidamente.
                    </td>
                    <td style="padding: 15px; color: #ccc;">
                        Requiere mayor disciplina y organizaciÃ³n manual a medida que crece el proyecto para evitar "Spaghetti Code".
                    </td>
                </tr>
                <!-- ImplementaciÃ³n -->
                <tr style="border-bottom: 1px solid #333; background: rgba(255,255,255,0.02);">
                    ...
                    <td style="padding: 15px; border-right: 1px solid #333; color: #ccc;">
                        RÃ¡pida implementaciÃ³n en proyectos pequeÃ±os o medianos (MVPs) al tener menos capas de abstracciÃ³n.
                    </td>
                    <td style="padding: 15px; color: #ccc;">
                        En proyectos complejos puede generar una estructura monolÃ­tica difÃ­cil de mantener y evolucionar.
                    </td>
                </tr>
                ...
                <tr style="border-bottom: 1px solid #333;">
                    ...
                    <td style="padding: 15px; color: #ccc;">
                        Puede surgir acoplamiento excesivo entre la Vista y el Controlador, llevando al anti-patrÃ³n "Massive View Controller".
                    </td>
                </tr>
                <!-- Escalabilidad -->
                <tr style="border-bottom: 1px solid #333; background: rgba(255,255,255,0.02);">
                    ...
                    <td style="padding: 15px; color: #ccc;">
                        No es ideal para aplicaciones mÃ³viles de gran escala (Enterprise) debido a la rigidez y dificultad para modularizar.
                    </td>
                </tr>
                <!-- Costo Inicial -->
                <tr style="border-bottom: 1px solid #333;">
                    ...
                    <td style="padding: 15px; border-right: 1px solid #333; color: #ccc;">
                        <strong>Bajo costo.</strong> Requiere configuraciÃ³n mÃ­nima y herramientas estÃ¡ndar gratuitas.
                    </td>
                    <td style="padding: 15px; color: #ccc;">
                        La deuda tÃ©cnica puede aumentar rÃ¡pidamente, requiriendo refactorizaciÃ³n costosa a futuro si no se migra a tiempo.
                    </td>
                </tr>
                <!-- Testing -->
                <tr style="border-bottom: 1px solid #333; background: rgba(255,255,255,0.02);">
                    ...
                    <td style="padding: 15px; border-right: 1px solid #333; color: #ccc;">
                        Permite pruebas unitarias sencillas para el Modelo (lÃ³gica de negocio pura y datos).
                    </td>
                    <td style="padding: 15px; color: #ccc;">
                        Es muy difÃ­cil probar la lÃ³gica de UI y del Controlador debido al alto acoplamiento con las APIs del sistema operativo.
                    </td>
                </tr>
            </tbody>
        </table>
